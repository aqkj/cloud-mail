...
const premKey = {
	...
	'all-email:query': ['/allEmail/list','/allEmail/latest','/email/latestByTo'],
	'all-email:delete': ['/allEmail/delete','/allEmail/batchDelete','/allEmail/autoClean'],
	'category:query': ['/category/list','/category/rule/list'],
	'category:set': ['/category/add','/category/update','/category/delete','/category/rule/add','/category/rule/update','/category/rule/delete','/category/reclassify'],
	'setting:query': ['/setting/query','/setting/domain/list'],
	'setting:set': ['/setting/set', '/setting/setBackground','/setting/deleteBackground','/setting/setBlacklist','/setting/domain/add','/setting/domain/delete','/setting/domain/replace','/setting/domain/ensureKv'],
