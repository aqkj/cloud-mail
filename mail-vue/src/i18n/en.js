const en = {
    ...
    addDomainPlaceholder: 'Enter domains, separated by commas or new lines',
    batchDomainPlaceholder: 'Enter one domain per line, comma-separated input is also supported',
