const zh = {
    ...
    domain: '域名',
    emailDomain: '邮箱域名',
    emailDomainDesc: '管理可注册、添加、收发的邮箱域名，数据保存到 KV',
    domainCount: '{count} 个域名',
    domainKvKey: 'KV Key',
    searchDomain: '搜索域名',
    addDomainPlaceholder: '输入域名或通配规则，例如 example.com、*.example.com',
    batchDomainPlaceholder: '批量输入域名或通配规则，一行一个，也支持逗号分隔',
    domainWildcardTip: 'example.com 只匹配根域名；*.example.com 匹配 a.example.com、b.c.example.com 等子域名，不匹配 example.com 本身。',
    domainRuleType: '类型',
    exactDomain: '精确',
    wildcardDomain: '通配',
    batchImport: '批量导入',
    saveToKv: '写入 KV',
    emptyDomainMsg: '域名不能为空',
    invalidDomainMsg: '非法域名：{domain}',
    optional: '可选',
    ...
    clearSuccess: '清除成功',
    clearSuccessWithCount: '清除成功，共清理 {count} 封',
    clearProgress: '正在清理，已处理 {count} 封...',
    clearProgressWithTotal: '正在清理，已处理 {count}/{total} 封（{percent}%）',
    emptyRole: '身份类型不能为空',
    ...
    trailing: '右匹配',
    regex: '正则',
    deleteCategoryConfirm: '确认删除分类 {name} 吗？分类下的规则和邮件关系也会删除。',
    ...
    scheduledCleanupLastRun: '上次执行：{time}，清理 {count} 封',
    saveScheduledCleanup: '保存定时清理',
    scheduledCleanupConditionRequired: '启用定时清理至少需要一个清理条件',
